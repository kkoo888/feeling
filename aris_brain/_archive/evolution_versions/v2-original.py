...
logger = logging.getLogger("aris.fusion_v2")
...
class FusionEngineV2:
    ...
    def _generate_output(
        ...
        if intent == "greeting":
            ...
            return f"[状态查询] 系统运行正常，当前引擎: fusion_v2"
            ...
            if decision["action"] == "fallback":
                return ""
            return f"[融合引擎V2] intent={intent}, confidence={fusion.confidence:.2f}"
